...
- Report the PR number and URL to the user as a markdown link.
...
### Branch Naming (this project)
Follow the QA automation branch convention from `rules/architecture.md`:
...
**Never push directly to `main`.** All changes must go via a branch and be merged via PR with user approval.
